...
// ==========================================
// HERO SECTION LOGIC (MATH SCROLL)
// ==========================================
...
            e.preventDefault(); 
            
            // 1. Auto-click the first algorithm (Linear Search) to build the UI
            const firstAlgo = document.querySelector('.sidebar-nav li');
            if (firstAlgo) firstAlgo.click();

            // 2. Scroll down exactly 1 screen height
            window.scrollBy({ 
